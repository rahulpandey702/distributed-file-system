...
lab7: lock_tester lock_server rsm_tester extent_server yfs_client test-lab-3-b test-lab-3-c
...
hfiles5=rsm_state_transfer.h rsm_client.h Sleep.h
...
ifeq ($(LAB7GE),1)
  lock_tester+=rsm_client.cc handle.cc lock_client_cache_rsm.cc extent_client_cache.cc extent_client.cc
endif
...
ifeq ($(LAB7GE),1)
  yfs_client += lock_client_cache_rsm.cc handle.cc rsm_client.cc
endif
